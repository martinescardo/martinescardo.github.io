...
-- Click a module name to navigate to it:
...
open import Uniform-continuity-of-T-definable-functions

-- Source files at
-- http://www.cs.bham.ac.uk/~mhe/papers/xu-escardo/C-space-3/agda/
